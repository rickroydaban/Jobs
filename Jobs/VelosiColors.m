...
+ (UIColor *)orangeVelosi{
    return [UIColor colorWithRed:234/255.0f green:101/255.0f blue:26/255.0f alpha:1.0f];
}

+ (UIColor *)orangeLighter{
    return [UIColor colorWithRed:255/255.0f green:178/255.0f blue:114/255.0f alpha:1.0f];
}
...
+ (UIColor *)orangeDarker{
    return [UIColor colorWithRed:170/255.0f green:73/255.0f blue:0/255.0f alpha:1.0f];
}

+ (UIColor *)lightGray{
    return [UIColor colorWithRed:218/255.0f green:218/255.0f blue:218/255.0f alpha:1.0f];
}
...
+ (UIColor *)blackFont{
    return [UIColor colorWithRed:42/255.0f green:42/255.0f blue:42/255.0f alpha:1.0f];
}

+ (UIColor *)blue{
    return [UIColor colorWithRed:135/255.0f green:206/255.0f blue:235/255.0f alpha:1.0f];
}

+ (UIColor *)blueDarker{
    return [UIColor colorWithRed:93/255.0f green:123/255.0f blue:157/255.0f alpha:1.0f];
}
...
+ (UIColor *)listSeparator{
    return [UIColor colorWithRed:112/255.0f green:112/255.0f blue:112/255.0f alpha:1.0f];
}

+ (UIColor *)homePageSectionBackground{
    return [UIColor colorWithRed:128/255.0f green:128/255.0f blue:128/255.0f alpha:1.0f];
}
...
+ (UIColor *)whiteSidebarBG{
    return [UIColor colorWithRed:197/255.0f green:197/255.0f blue:197/255.0f alpha:1.0f];
}

+ (UIColor *)whiteSidebarFont{
    return [UIColor colorWithRed:47/255.0f green:47/255.0f blue:47/255.0f alpha:1.0f];
}

+ (UIColor *)whiteSidebarCellBG{
    return [UIColor colorWithRed:181/255.0f green:181/255.0f blue:181/255.0f alpha:1.0f];
}
