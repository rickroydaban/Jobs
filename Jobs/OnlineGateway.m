...
- (User *)authenticateUserName:(NSString *)username password:(NSString *)password{
    ...
    @try {
        ...
        if(jsonResults){
            ...
            NSMutableArray *locationPrefs = ([[results objectForKey:@"PreferredLocation"] isEqualToString:@""])?[NSMutableArray array]:[NSMutableArray arrayWithArray:[results objectForKey:@"PreferredLocation"]];
