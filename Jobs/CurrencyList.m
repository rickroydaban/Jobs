...
- (CurrencyList *)init{
    ...
    if (self) {
        _currencySymbolList = @[CURRENCYSYM_AED, CURRENCYSYM_ALL, CURRENCYSYM_ANG, CURRENCYSYM_ARS, CURRENCYSYM_AUD, CURRENCYSYM_AWG, CURRENCYSYM_BBD, CURRENCYSYM_BDT, CURRENCYSYM_BGN, CURRENCYSYM_BHD, CURRENCYSYM_BIF, CURRENCYSYM_BMD, CURRENCYSYM_BND, CURRENCYSYM_BOB, CURRENCYSYM_BRL, CURRENCYSYM_BSD, CURRENCYSYM_BTN, CURRENCYSYM_BWP, CURRENCYSYM_BYR, CURRENCYSYM_BZD, CURRENCYSYM_CAD, CURRENCYSYM_CHF, CURRENCYSYM_CLP, CURRENCYSYM_CNY, CURRENCYSYM_COP, CURRENCYSYM_CRC, CURRENCYSYM_CUP, CURRENCYSYM_CVE, CURRENCYSYM_CZK, CURRENCYSYM_DJF, CURRENCYSYM_DKK, CURRENCYSYM_DOP, CURRENCYSYM_DZD, CURRENCYSYM_EEK, CURRENCYSYM_EGP, CURRENCYSYM_ETB, CURRENCYSYM_EUR, CURRENCYSYM_FJD, CURRENCYSYM_FKP, CURRENCYSYM_GBP, CURRENCYSYM_GIP, CURRENCYSYM_GMD, CURRENCYSYM_GNF, CURRENCYSYM_GTQ, CURRENCYSYM_GYD, CURRENCYSYM_HKD, CURRENCYSYM_HNL, CURRENCYSYM_HRK, CURRENCYSYM_HTG, CURRENCYSYM_HUF, CURRENCYSYM_IDR, CURRENCYSYM_ILS, CURRENCYSYM_INR, CURRENCYSYM_IQD, CURRENCYSYM_IRR, CURRENCYSYM_ISK, CURRENCYSYM_JMD, CURRENCYSYM_JOD, CURRENCYSYM_JPY, CURRENCYSYM_KES, CURRENCYSYM_KHR, CURRENCYSYM_KMF, CURRENCYSYM_KPW, CURRENCYSYM_KRW, CURRENCYSYM_KWD, CURRENCYSYM_KYD, CURRENCYSYM_KZT, CURRENCYSYM_LAK, CURRENCYSYM_LBP, CURRENCYSYM_LKR, CURRENCYSYM_LRD, CURRENCYSYM_LSL, CURRENCYSYM_LTL, CURRENCYSYM_LVL, CURRENCYSYM_LYD, CURRENCYSYM_MAD, CURRENCYSYM_MDL, CURRENCYSYM_MKD, CURRENCYSYM_MMK, CURRENCYSYM_MNT, CURRENCYSYM_MOP, CURRENCYSYM_MRO, CURRENCYSYM_MUR, CURRENCYSYM_MVR, CURRENCYSYM_MWK, CURRENCYSYM_MXN, CURRENCYSYM_MYR, CURRENCYSYM_NAD, CURRENCYSYM_NGN, CURRENCYSYM_NIO, CURRENCYSYM_NOK, CURRENCYSYM_NPR, CURRENCYSYM_NZD, CURRENCYSYM_OMR, CURRENCYSYM_PAB, CURRENCYSYM_PEN, CURRENCYSYM_PGK, CURRENCYSYM_PHP, CURRENCYSYM_PKR, CURRENCYSYM_PLN, CURRENCYSYM_PYG, CURRENCYSYM_QAR, CURRENCYSYM_RON, CURRENCYSYM_RUB, CURRENCYSYM_RWF, CURRENCYSYM_SAR, CURRENCYSYM_SBD, CURRENCYSYM_SCR, CURRENCYSYM_SEK, CURRENCYSYM_SGD, CURRENCYSYM_SHP, CURRENCYSYM_SKK, CURRENCYSYM_SLL, CURRENCYSYM_SOS, CURRENCYSYM_STD, CURRENCYSYM_SVC, CURRENCYSYM_SYP, CURRENCYSYM_SZL, CURRENCYSYM_THB, CURRENCYSYM_TND, CURRENCYSYM_TOP, CURRENCYSYM_TRY, CURRENCYSYM_TTD, CURRENCYSYM_TWD, CURRENCYSYM_TZS, CURRENCYSYM_UAH, CURRENCYSYM_UGX, CURRENCYSYM_USD, CURRENCYSYM_UYU, CURRENCYSYM_VND, CURRENCYSYM_VUV, CURRENCYSYM_WST, CURRENCYSYM_XAF, CURRENCYSYM_XAG, CURRENCYSYM_XAU, CURRENCYSYM_XCD, CURRENCYSYM_XCP, CURRENCYSYM_XOF, CURRENCYSYM_XPD, CURRENCYSYM_XPF, CURRENCYSYM_XPT, CURRENCYSYM_YER, CURRENCYSYM_ZAR, CURRENCYSYM_ZMK, CURRENCYSYM_ZWD];
        
        _currencyNameList = @[CURRENCY_UAEDIRHAM, CURRENCY_ALBANIANLEK, CURRENCY_NETHANTILLESGUILDER, CURRENCY_ARGENTINEPESO, CURRENCY_AUSTRALIANDOLLAR, CURRENCY_ARUBAFLORIN, CURRENCY_BARBADOSDOLLAR, CURRENCY_BANGLADESHTAKA, CURRENCY_BULGARIANLEV, CURRENCY_BAHRAINIDINAR, CURRENCY_BURUNDIFRANC, CURRENCY_BERMUDADOLLAR, CURRENCY_BRUNEIDOLLAR, CURRENCY_BOLIVIANBOLIVIANO, CURRENCY_BRAZILIANREAL, CURRENCY_BAHAMIANDOLLAR, CURRENCY_BHUTANNGULTRUM, CURRENCY_BOTSWANAPULA, CURRENCY_BELARUSRUBLE, CURRENCY_BELIZEDOLLAR, CURRENCY_CANADIANDOLLAR, CURRENCY_SWISSFRANC, CURRENCY_CHILEANPESO, CURRENCY_CHINESEYUAN, CURRENCY_COLOMBIANPESO, CURRENCY_COSTARICACOLON, CURRENCY_CUBANPESO, CURRENCY_CAPEVERDEESCUDO, CURRENCY_CZECHKORUNA, CURRENCY_DIJIBOUTIFRANC, CURRENCY_DANISHKRONE, CURRENCY_DOMINICANPESO, CURRENCY_ALGERIANDINAR, CURRENCY_ESTONIANKROON, CURRENCY_EGYPTIANPOUND, CURRENCY_ETHIOPIANBIRR, CURRENCY_EURO, CURRENCY_FIJIDOLLAR, CURRENCY_FALKLANDISLANDSPOUND, CURRENCY_BRITISHPOUND, CURRENCY_GIBRALTARPOUND, CURRENCY_GAMBIANDALASI, CURRENCY_GUINEAFRANC, CURRENCY_GUATEMALAQUETZAL, CURRENCY_GUYANADOLLAR, CURRENCY_HONGKONGDOLLAR, CURRENCY_HONDURASLEMPIRA, CURRENCY_CROATIANKUNA, CURRENCY_HAITIGOURDE, CURRENCY_HUNGARIANFORINT, CURRENCY_INDONESIANRUPIAH, CURRENCY_ISRAELISHEKEL, CURRENCY_INDIANRUPEE, CURRENCY_IRAQIDINAR, CURRENCY_IRANRIAL, CURRENCY_ICELANDKRONA, CURRENCY_JAMAICANDOLLAR, CURRENCY_JORDANIANDINAR, CURRENCY_JAPANESEYEN, CURRENCY_KENYANSHILLING, CURRENCY_CAMBODIARIEL, CURRENCY_COMOROSFRANC, CURRENCY_NORTHKOREANWON, CURRENCY_KOREANWON, CURRENCY_KUWAITIDINAR, CURRENCY_CAYMANISLANDSDOLLAR, CURRENCY_KAZAKHSTANTENGE, CURRENCY_LAOKIP, CURRENCY_LEBANESEPOUND, CURRENCY_SRILANKARUPEE, CURRENCY_LIBERIANDOLLAR, CURRENCY_LESOTHOLOTI, CURRENCY_LITHUANIANLITA, CURRENCY_LATVIANLAT, CURRENCY_LIBYANDINAR, CURRENCY_MOROCCANDIRHAM, CURRENCY_MOLDOVANLEU, CURRENCY_MACEDONIANDENAR, CURRENCY_MYANMARKYAT, CURRENCY_MONGOLIANTUGRIK, CURRENCY_MACAUPATACA, CURRENCY_MAURITANIAOUGULYA, CURRENCY_MAURITIUSRUPEE, CURRENCY_MALDIVESRUFIYAA, CURRENCY_MALAWIKWACHA, CURRENCY_MEXICANPESO, CURRENCY_MALAYSIANRINGGIT, CURRENCY_NAMIBIANDOLLAR, CURRENCY_NIGERIANNAIRA, CURRENCY_NICARAGUACORDOBA, CURRENCY_NORWEGIANKRONE, CURRENCY_NEPALESERUPEE, CURRENCY_NEWZEALANDDOLLAR, CURRENCY_OMANIRIAL, CURRENCY_PANAMABALBOA, CURRENCY_PERUVIANNUEVOSOL, CURRENCY_PAPUANEWGUINEAKINA, CURRENCY_PHILIPPINEPESO, CURRENCY_PAKISTANIRUPEE, CURRENCY_POLISHZLOTY, CURRENCY_PARAGUAYANGUARANI, CURRENCY_QATARRIAL, CURRENCY_ROMANIANNEWLEU, CURRENCY_RUSSIANROUBLE, CURRENCY_RWANDAFRANC, CURRENCY_SAUDIARABIANRIYAL, CURRENCY_SOLOMONISLANDSDOLLAR, CURRENCY_SEYCHELLESRUPEE, CURRENCY_SWEDISHKRONA, CURRENCY_SINGAPOREDOLLAR, CURRENCY_STHELENAPOUND, CURRENCY_SLOVAKKORUNA, CURRENCY_SIERRALEONELEONE, CURRENCY_SOMALISHILLING, CURRENCY_SAOTOMEDOBRA, CURRENCY_ELSALVADORCOLON, CURRENCY_SYRIANPOUND, CURRENCY_SWAZILANDLILAGENI, CURRENCY_THAIBAHT, CURRENCY_TUNISIANDINAR, CURRENCY_TONGAPAANGA, CURRENCY_TURKISHLIRA, CURRENCY_TRINIDADTOBAGODOLLAR, CURRENCY_TAIWANDOLLAR, CURRENCY_TANZANIANSHILLING, CURRENCY_UKRAINEHRYVNIA, CURRENCY_UGANDANSHILLING, CURRENCY_USDOLLAR, CURRENCY_URUGUAYANNEWPESO, CURRENCY_VIETNAMDONG, CURRENCY_VANUATUVATU, CURRENCY_SAMOATALA, CURRENCY_CFAFRANC, CURRENCY_SILVEROUNCES, CURRENCY_GOLDOUNCES, CURRENCY_EASTCARIBBEANDOLLAR, CURRENCY_COPPERPOUNDS, CURRENCY_CFAFRANC, CURRENCY_PALLADIUMOUNCES, CURRENCY_PACIFICFRANC, CURRENCY_PLATINUMOUNCES, CURRENCY_YEMENRIYAL, CURRENCY_SOUTHAFRICANRAND, CURRENCY_ZAMBIANKWACHA, CURRENCY_ZIMBABWEDOLLAR];
        
        [_currencySymbolNamesDict setValue:CURRENCY_UAEDIRHAM forKey:CURRENCYSYM_AED];
        [_currencySymbolNamesDict setValue:CURRENCY_ALBANIANLEK forKey:CURRENCYSYM_ALL];
        [_currencySymbolNamesDict setValue:CURRENCY_NETHANTILLESGUILDER forKey:CURRENCYSYM_ANG];
        [_currencySymbolNamesDict setValue:CURRENCY_ARGENTINEPESO forKey:CURRENCYSYM_ARS];
        [_currencySymbolNamesDict setValue:CURRENCY_AUSTRALIANDOLLAR forKey:CURRENCYSYM_AUD];
        [_currencySymbolNamesDict setValue:CURRENCY_ARUBAFLORIN forKey:CURRENCYSYM_AWG];
        [_currencySymbolNamesDict setValue:CURRENCY_BARBADOSDOLLAR forKey:CURRENCYSYM_BBD];
        [_currencySymbolNamesDict setValue:CURRENCY_BANGLADESHTAKA forKey:CURRENCYSYM_BDT];
        [_currencySymbolNamesDict setValue:CURRENCY_BULGARIANLEV forKey:CURRENCYSYM_BGN];
        [_currencySymbolNamesDict setValue:CURRENCY_BAHRAINIDINAR forKey:CURRENCYSYM_BHD];
        [_currencySymbolNamesDict setValue:CURRENCY_BURUNDIFRANC forKey:CURRENCYSYM_BIF];
        [_currencySymbolNamesDict setValue:CURRENCY_BERMUDADOLLAR forKey:CURRENCYSYM_BMD];
        [_currencySymbolNamesDict setValue:CURRENCY_BRUNEIDOLLAR forKey:CURRENCYSYM_BND];
        [_currencySymbolNamesDict setValue:CURRENCY_BOLIVIANBOLIVIANO forKey:CURRENCYSYM_BOB];
        [_currencySymbolNamesDict setValue:CURRENCY_BRAZILIANREAL forKey:CURRENCYSYM_BRL];
        [_currencySymbolNamesDict setValue:CURRENCY_BAHAMIANDOLLAR forKey:CURRENCYSYM_BSD];
        [_currencySymbolNamesDict setValue:CURRENCY_BHUTANNGULTRUM forKey:CURRENCYSYM_BTN];
        [_currencySymbolNamesDict setValue:CURRENCY_BOTSWANAPULA forKey:CURRENCYSYM_BWP];
        [_currencySymbolNamesDict setValue:CURRENCY_BELARUSRUBLE forKey:CURRENCYSYM_BYR];
        [_currencySymbolNamesDict setValue:CURRENCY_BELIZEDOLLAR forKey:CURRENCYSYM_BZD];
        [_currencySymbolNamesDict setValue:CURRENCY_CANADIANDOLLAR forKey:CURRENCYSYM_CAD];
        [_currencySymbolNamesDict setValue:CURRENCY_SWISSFRANC forKey:CURRENCYSYM_CHF];
        [_currencySymbolNamesDict setValue:CURRENCY_CHILEANPESO forKey:CURRENCYSYM_CLP];
        [_currencySymbolNamesDict setValue:CURRENCY_CHINESEYUAN forKey:CURRENCYSYM_CNY];
        [_currencySymbolNamesDict setValue:CURRENCY_COLOMBIANPESO forKey:CURRENCYSYM_COP];
        [_currencySymbolNamesDict setValue:CURRENCY_COSTARICACOLON forKey:CURRENCYSYM_CRC];
        [_currencySymbolNamesDict setValue:CURRENCY_CUBANPESO forKey:CURRENCYSYM_CUP];
        [_currencySymbolNamesDict setValue:CURRENCY_CAPEVERDEESCUDO forKey:CURRENCYSYM_CVE];
        [_currencySymbolNamesDict setValue:CURRENCY_CZECHKORUNA forKey:CURRENCYSYM_CZK];
        [_currencySymbolNamesDict setValue:CURRENCY_DIJIBOUTIFRANC forKey:CURRENCYSYM_DJF];
        [_currencySymbolNamesDict setValue:CURRENCY_DANISHKRONE forKey:CURRENCYSYM_DKK];
        [_currencySymbolNamesDict setValue:CURRENCY_DOMINICANPESO forKey:CURRENCYSYM_DOP];
        [_currencySymbolNamesDict setValue:CURRENCY_ALGERIANDINAR forKey:CURRENCYSYM_DZD];
        [_currencySymbolNamesDict setValue:CURRENCY_ESTONIANKROON forKey:CURRENCYSYM_EEK];
        [_currencySymbolNamesDict setValue:CURRENCY_EGYPTIANPOUND forKey:CURRENCYSYM_EGP];
        [_currencySymbolNamesDict setValue:CURRENCY_ETHIOPIANBIRR forKey:CURRENCYSYM_ETB];
        [_currencySymbolNamesDict setValue:CURRENCY_EURO forKey:CURRENCYSYM_EUR];
        [_currencySymbolNamesDict setValue:CURRENCY_FIJIDOLLAR forKey:CURRENCYSYM_FJD];
        [_currencySymbolNamesDict setValue:CURRENCY_FALKLANDISLANDSPOUND forKey:CURRENCYSYM_FKP];
        [_currencySymbolNamesDict setValue:CURRENCY_BRITISHPOUND forKey:CURRENCYSYM_GBP];
        [_currencySymbolNamesDict setValue:CURRENCY_GIBRALTARPOUND forKey:CURRENCYSYM_GIP];
        [_currencySymbolNamesDict setValue:CURRENCY_GAMBIANDALASI forKey:CURRENCYSYM_GMD];
        [_currencySymbolNamesDict setValue:CURRENCY_GUINEAFRANC forKey:CURRENCYSYM_GNF];
        [_currencySymbolNamesDict setValue:CURRENCY_GUATEMALAQUETZAL forKey:CURRENCYSYM_GTQ];
        [_currencySymbolNamesDict setValue:CURRENCY_GUYANADOLLAR forKey:CURRENCYSYM_GYD];
        [_currencySymbolNamesDict setValue:CURRENCY_HONGKONGDOLLAR forKey:CURRENCYSYM_HKD];
        [_currencySymbolNamesDict setValue:CURRENCY_HONDURASLEMPIRA forKey:CURRENCYSYM_HNL];
        [_currencySymbolNamesDict setValue:CURRENCY_CROATIANKUNA forKey:CURRENCYSYM_HRK];
        [_currencySymbolNamesDict setValue:CURRENCY_HAITIGOURDE forKey:CURRENCYSYM_HTG];
        [_currencySymbolNamesDict setValue:CURRENCY_HUNGARIANFORINT forKey:CURRENCYSYM_HUF];
        [_currencySymbolNamesDict setValue:CURRENCY_INDONESIANRUPIAH forKey:CURRENCYSYM_IDR];
        [_currencySymbolNamesDict setValue:CURRENCY_ISRAELISHEKEL forKey:CURRENCYSYM_ILS];
        [_currencySymbolNamesDict setValue:CURRENCY_INDIANRUPEE forKey:CURRENCYSYM_INR];
        [_currencySymbolNamesDict setValue:CURRENCY_IRAQIDINAR forKey:CURRENCYSYM_IQD];
        [_currencySymbolNamesDict setValue:CURRENCY_IRANRIAL forKey:CURRENCYSYM_IRR];
        [_currencySymbolNamesDict setValue:CURRENCY_ICELANDKRONA forKey:CURRENCYSYM_ISK];
        [_currencySymbolNamesDict setValue:CURRENCY_JAMAICANDOLLAR forKey:CURRENCYSYM_JMD];
        [_currencySymbolNamesDict setValue:CURRENCY_JORDANIANDINAR forKey:CURRENCYSYM_JOD];
        [_currencySymbolNamesDict setValue:CURRENCY_JAPANESEYEN forKey:CURRENCYSYM_JPY];
        [_currencySymbolNamesDict setValue:CURRENCY_KENYANSHILLING forKey:CURRENCYSYM_KES];
        [_currencySymbolNamesDict setValue:CURRENCY_CAMBODIARIEL forKey:CURRENCYSYM_KHR];
        [_currencySymbolNamesDict setValue:CURRENCY_COMOROSFRANC forKey:CURRENCYSYM_KMF];
        [_currencySymbolNamesDict setValue:CURRENCY_NORTHKOREANWON forKey:CURRENCYSYM_KPW];
        [_currencySymbolNamesDict setValue:CURRENCY_KOREANWON forKey:CURRENCYSYM_KRW];
        [_currencySymbolNamesDict setValue:CURRENCY_KUWAITIDINAR forKey:CURRENCYSYM_KWD];
        [_currencySymbolNamesDict setValue:CURRENCY_CAYMANISLANDSDOLLAR forKey:CURRENCYSYM_KYD];
        [_currencySymbolNamesDict setValue:CURRENCY_KAZAKHSTANTENGE forKey:CURRENCYSYM_KZT];
        [_currencySymbolNamesDict setValue:CURRENCY_LAOKIP forKey:CURRENCYSYM_LAK];
        [_currencySymbolNamesDict setValue:CURRENCY_LEBANESEPOUND forKey:CURRENCYSYM_LBP];
        [_currencySymbolNamesDict setValue:CURRENCY_SRILANKARUPEE forKey:CURRENCYSYM_LKR];
        [_currencySymbolNamesDict setValue:CURRENCY_LIBERIANDOLLAR forKey:CURRENCYSYM_LRD];
        [_currencySymbolNamesDict setValue:CURRENCY_LESOTHOLOTI forKey:CURRENCYSYM_LSL];
        [_currencySymbolNamesDict setValue:CURRENCY_LITHUANIANLITA forKey:CURRENCYSYM_LTL];
        [_currencySymbolNamesDict setValue:CURRENCY_LATVIANLAT forKey:CURRENCYSYM_LVL];
        [_currencySymbolNamesDict setValue:CURRENCY_LIBYANDINAR forKey:CURRENCYSYM_LYD];
        [_currencySymbolNamesDict setValue:CURRENCY_MOROCCANDIRHAM forKey:CURRENCYSYM_MAD];
        [_currencySymbolNamesDict setValue:CURRENCY_MOLDOVANLEU forKey:CURRENCYSYM_MDL];
        [_currencySymbolNamesDict setValue:CURRENCY_MACEDONIANDENAR forKey:CURRENCYSYM_MKD];
        [_currencySymbolNamesDict setValue:CURRENCY_MYANMARKYAT forKey:CURRENCYSYM_MMK];
        [_currencySymbolNamesDict setValue:CURRENCY_MONGOLIANTUGRIK forKey:CURRENCYSYM_MNT];
        [_currencySymbolNamesDict setValue:CURRENCY_MACAUPATACA forKey:CURRENCYSYM_MOP];
        [_currencySymbolNamesDict setValue:CURRENCY_MAURITANIAOUGULYA forKey:CURRENCYSYM_MRO];
        [_currencySymbolNamesDict setValue:CURRENCY_MAURITIUSRUPEE forKey:CURRENCYSYM_MUR];
        [_currencySymbolNamesDict setValue:CURRENCY_MALDIVESRUFIYAA forKey:CURRENCYSYM_MVR];
        [_currencySymbolNamesDict setValue:CURRENCY_MALAWIKWACHA forKey:CURRENCYSYM_MWK];
        [_currencySymbolNamesDict setValue:CURRENCY_MEXICANPESO forKey:CURRENCYSYM_MXN];
        [_currencySymbolNamesDict setValue:CURRENCY_MALAYSIANRINGGIT forKey:CURRENCYSYM_MYR];
        [_currencySymbolNamesDict setValue:CURRENCY_NAMIBIANDOLLAR forKey:CURRENCYSYM_NAD];
        [_currencySymbolNamesDict setValue:CURRENCY_NIGERIANNAIRA forKey:CURRENCYSYM_NGN];
        [_currencySymbolNamesDict setValue:CURRENCY_NICARAGUACORDOBA forKey:CURRENCYSYM_NIO];
        [_currencySymbolNamesDict setValue:CURRENCY_NORWEGIANKRONE forKey:CURRENCYSYM_NOK];
        [_currencySymbolNamesDict setValue:CURRENCY_NEPALESERUPEE forKey:CURRENCYSYM_NPR];
        [_currencySymbolNamesDict setValue:CURRENCY_NEWZEALANDDOLLAR forKey:CURRENCYSYM_NZD];
        [_currencySymbolNamesDict setValue:CURRENCY_OMANIRIAL forKey:CURRENCYSYM_OMR];
        [_currencySymbolNamesDict setValue:CURRENCY_PANAMABALBOA forKey:CURRENCYSYM_PAB];
        [_currencySymbolNamesDict setValue:CURRENCY_PERUVIANNUEVOSOL forKey:CURRENCYSYM_PEN];
        [_currencySymbolNamesDict setValue:CURRENCY_PAPUANEWGUINEAKINA forKey:CURRENCYSYM_PGK];
        [_currencySymbolNamesDict setValue:CURRENCY_PHILIPPINEPESO forKey:CURRENCYSYM_PHP];
        [_currencySymbolNamesDict setValue:CURRENCY_PAKISTANIRUPEE forKey:CURRENCYSYM_PKR];
        [_currencySymbolNamesDict setValue:CURRENCY_POLISHZLOTY forKey:CURRENCYSYM_PLN];
        [_currencySymbolNamesDict setValue:CURRENCY_PARAGUAYANGUARANI forKey:CURRENCYSYM_PYG];
        [_currencySymbolNamesDict setValue:CURRENCY_QATARRIAL forKey:CURRENCYSYM_QAR];
        [_currencySymbolNamesDict setValue:CURRENCY_ROMANIANNEWLEU forKey:CURRENCYSYM_RON];
        [_currencySymbolNamesDict setValue:CURRENCY_RUSSIANROUBLE forKey:CURRENCYSYM_RUB];
        [_currencySymbolNamesDict setValue:CURRENCY_RWANDAFRANC forKey:CURRENCYSYM_RWF];
        [_currencySymbolNamesDict setValue:CURRENCY_SAUDIARABIANRIYAL forKey:CURRENCYSYM_SAR];
        [_currencySymbolNamesDict setValue:CURRENCY_SOLOMONISLANDSDOLLAR forKey:CURRENCYSYM_SBD];
        [_currencySymbolNamesDict setValue:CURRENCY_SEYCHELLESRUPEE forKey:CURRENCYSYM_SCR];
        [_currencySymbolNamesDict setValue:CURRENCY_SWEDISHKRONA forKey:CURRENCYSYM_SEK];
        [_currencySymbolNamesDict setValue:CURRENCY_SINGAPOREDOLLAR forKey:CURRENCYSYM_SGD];
        [_currencySymbolNamesDict setValue:CURRENCY_STHELENAPOUND forKey:CURRENCYSYM_SHP];
        [_currencySymbolNamesDict setValue:CURRENCY_SLOVAKKORUNA forKey:CURRENCYSYM_SKK];
        [_currencySymbolNamesDict setValue:CURRENCY_SIERRALEONELEONE forKey:CURRENCYSYM_SLL];
        [_currencySymbolNamesDict setValue:CURRENCY_SOMALISHILLING forKey:CURRENCYSYM_SOS];
        [_currencySymbolNamesDict setValue:CURRENCY_SAOTOMEDOBRA forKey:CURRENCYSYM_STD];
        [_currencySymbolNamesDict setValue:CURRENCY_ELSALVADORCOLON forKey:CURRENCYSYM_SVC];
        [_currencySymbolNamesDict setValue:CURRENCY_SYRIANPOUND forKey:CURRENCYSYM_SYP];
        [_currencySymbolNamesDict setValue:CURRENCY_SWAZILANDLILAGENI forKey:CURRENCYSYM_SZL];
        [_currencySymbolNamesDict setValue:CURRENCY_THAIBAHT forKey:CURRENCYSYM_THB];
        [_currencySymbolNamesDict setValue:CURRENCY_TUNISIANDINAR forKey:CURRENCYSYM_TND];
        [_currencySymbolNamesDict setValue:CURRENCY_TONGAPAANGA forKey:CURRENCYSYM_TOP];
        [_currencySymbolNamesDict setValue:CURRENCY_TURKISHLIRA forKey:CURRENCYSYM_TRY];
        [_currencySymbolNamesDict setValue:CURRENCY_TRINIDADTOBAGODOLLAR forKey:CURRENCYSYM_TTD];
        [_currencySymbolNamesDict setValue:CURRENCY_TAIWANDOLLAR forKey:CURRENCYSYM_TWD];
        [_currencySymbolNamesDict setValue:CURRENCY_TANZANIANSHILLING forKey:CURRENCYSYM_TZS];
        [_currencySymbolNamesDict setValue:CURRENCY_UKRAINEHRYVNIA forKey:CURRENCYSYM_UAH];
        [_currencySymbolNamesDict setValue:CURRENCY_UGANDANSHILLING forKey:CURRENCYSYM_UGX];
        [_currencySymbolNamesDict setValue:CURRENCY_USDOLLAR forKey:CURRENCYSYM_USD];
        [_currencySymbolNamesDict setValue:CURRENCY_URUGUAYANNEWPESO forKey:CURRENCYSYM_UYU];
        [_currencySymbolNamesDict setValue:CURRENCY_VIETNAMDONG forKey:CURRENCYSYM_VND];
        [_currencySymbolNamesDict setValue:CURRENCY_VANUATUVATU forKey:CURRENCYSYM_VUV];
        [_currencySymbolNamesDict setValue:CURRENCY_SAMOATALA forKey:CURRENCYSYM_WST];
        [_currencySymbolNamesDict setValue:CURRENCY_CFAFRANC forKey:CURRENCYSYM_XAF];
        [_currencySymbolNamesDict setValue:CURRENCY_SILVEROUNCES forKey:CURRENCYSYM_XAG];
        [_currencySymbolNamesDict setValue:CURRENCY_GOLDOUNCES forKey:CURRENCYSYM_XAU];
        [_currencySymbolNamesDict setValue:CURRENCY_EASTCARIBBEANDOLLAR forKey:CURRENCYSYM_XCD];
        [_currencySymbolNamesDict setValue:CURRENCY_COPPERPOUNDS forKey:CURRENCYSYM_XCP];
        [_currencySymbolNamesDict setValue:CURRENCY_CFAFRANC forKey:CURRENCYSYM_XOF];
        [_currencySymbolNamesDict setValue:CURRENCY_PALLADIUMOUNCES forKey:CURRENCYSYM_XPD];
        [_currencySymbolNamesDict setValue:CURRENCY_PACIFICFRANC forKey:CURRENCYSYM_XPF];
        [_currencySymbolNamesDict setValue:CURRENCY_PLATINUMOUNCES forKey:CURRENCYSYM_XPT];
        [_currencySymbolNamesDict setValue:CURRENCY_YEMENRIYAL forKey:CURRENCYSYM_YER];
        [_currencySymbolNamesDict setValue:CURRENCY_SOUTHAFRICANRAND forKey:CURRENCYSYM_ZAR];
        [_currencySymbolNamesDict setValue:CURRENCY_ZAMBIANKWACHA forKey:CURRENCYSYM_ZMK];
        [_currencySymbolNamesDict setValue:CURRENCY_ZIMBABWEDOLLAR forKey:CURRENCYSYM_ZWD];
